      ...
      <div style={{ maxWidth: "920px", margin: "0 auto", padding: "32px 20px" }}>
                    ...
                    return (
                      <tr key={i} style={{ borderBottom: "1px solid #f9fafb" }}>
                        ...
                        <td style={{ padding: "10px 12px" }}>
                          <span style={{ background: statusStyle.bg, color: statusStyle.text, fontSize: "11px", fontWeight: 700, padding: "3px 10px", borderRadius: "6px", whiteSpace: "nowrap" }}>
                            {statusStyle.label}
                          </span>
                        </td>
                      </tr>
        ...
        <div style={{ background: "#0a2e1a", borderRadius: "20px", padding: "28px 32px" }}>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "16px" }}>
            <p style={{ margin: 0, fontSize: "13px", color: "#a3c9b0", lineHeight: 1.7 }}>
