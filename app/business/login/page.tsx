        ...
        <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: "16px", padding: "28px 32px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
          {resetSent ? (
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              ...
              <p style={{ margin: "0 0 20px", fontSize: "14px", color: "#374151", lineHeight: "1.6" }}>
                We sent a password reset link to <b>{email}</b>. Click the link to set a new password.
              </p>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div style={{ marginBottom: "16px" }}>
                <label style={{ display: "block", fontSize: "13px", fontWeight: 700, color: "#111827", marginBottom: "6px" }}>Business email</label>
                <input style={inp} type="email" placeholder="you@yourbusiness.com" required
                  value={email} onChange={e => setEmail(e.target.value)} />
              </div>
              <div style={{ marginBottom: "8px" }}>
                <label style={{ display: "block", fontSize: "13px", fontWeight: 700, color: "#111827", marginBottom: "6px" }}>Password</label>
                <input style={inp} type="password" placeholder="Your password" required
