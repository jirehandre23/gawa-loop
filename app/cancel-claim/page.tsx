...
function CancelContent() {
  ...
  const message = {
    ...
    expired: "This listing has already expired so no action was needed. The food window has closed.",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: "24px", fontWeight: 800, color: config.color, margin: "0 0 12px" }}>
          {config.title}
        </h1>

        <p style={{ fontSize: "15px", color: config.color, lineHeight: 1.6, margin: "0 0 32px", opacity: 0.85 }}>
          {message}
        </p>
