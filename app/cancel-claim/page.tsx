...
function CancelContent() {
  ...
  const message: Record<string, string> = {
    ...
    success: `Your reservation for ${info.food || "this food"} at ${info.business || "the business"} has been cancelled.${info.relisted ? " The listing is now available for someone else to claim." : ""}`,
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f9fafb", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", padding: "24px" }}>
      <div style={{ background: c.bg, border: `2px solid ${c.border}`, borderRadius: "20px", padding: "48px 40px", maxWidth: "460px", width: "100%", textAlign: "center", boxShadow: "0 8px 32px rgba(0,0,0,0.08)" }}>
        ...
        {status !== "loading" && (
          <a href="/browse" style={{ display: "inline-block", background: "#16a34a", color: "#fff", fontWeight: 700, fontSize: "15px", padding: "14px 32px", borderRadius: "12px", textDecoration: "none", boxShadow: "0 4px 12px rgba(22,163,74,0.25)" }}>
