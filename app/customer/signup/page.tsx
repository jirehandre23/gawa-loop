    ...
    <div style={{ minHeight: "100vh", background: "#f0fdf4", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", fontFamily: "sans-serif" }}>
      <div style={{ background: "#fff", borderRadius: "20px", padding: "48px 40px", maxWidth: "480px", width: "100%", textAlign: "center", boxShadow: "0 8px 32px rgba(0,0,0,0.08)" }}>
        ...
        <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <a href="/customer/profile" style={{ display: "inline-block", background: "#f3f4f6", color: "#374151", fontWeight: 700, padding: "13px 28px", borderRadius: "10px", textDecoration: "none", fontSize: "15px", border: "1px solid #e5e7eb" }}>Set Up Profile</a>
        </div>
      </div>
    </div>
  );
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", marginBottom: "24px" }}>
          {["Terms", "Your Info"].map((label, i) => (
            <div key={label} style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <div style={{ width: "28px", height: "28px", borderRadius: "50%", fontSize: "13px", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", background: (i === 0 && step === "terms") || (i === 1 && step === "form") || (step === "form" && i === 0) ? "#16a34a" : "#e5e7eb", color: (i === 0 && step === "terms") || (i === 1 && step === "form") || (step === "form" && i === 0) ? "#fff" : "#9ca3af" }}>
                {step === "form" && i === 0 ? "✓" : i + 1}
              </div>
          ...
          {step === "terms" && (
            <div>
              ...
              <label style={checkRow} onClick={() => setAccepted(a => ({ ...a, terms: !a.terms }))}>
                ...
                <div>
                  <p style={{ margin: "0 0 2px", fontSize: "13px", fontWeight: 700, color: "#0a2e1a" }}>I agree to the Terms of Use *</p>
                  <p style={{ margin: 0, fontSize: "12px", color: "#6b7280", lineHeight: 1.5 }}>
                    I understand that GAWA Loop is a free community food-sharing platform. All food is provided by local businesses as a donation. I will use this platform respectfully and only for its intended purpose of accessing surplus food.
                  </p>
                </div>
              </label>

              <label style={checkRow} onClick={() => setAccepted(a => ({ ...a, privacy: !a.privacy }))}>
                <div style={{ width: "20px", height: "20px", borderRadius: "5px", border: `2px solid ${accepted.privacy ? "#16a34a" : "#d1d5db"}`, background: accepted.privacy ? "#16a34a" : "#fff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "1px" }}>
                  {accepted.privacy && <span style={{ color: "#fff", fontSize: "13px", fontWeight: 700 }}>✓</span>}
                </div>
                <div>
                  <p style={{ margin: "0 0 2px", fontSize: "13px", fontWeight: 700, color: "#0a2e1a" }}>I consent to data use *</p>
                  <p style={{ margin: 0, fontSize: "12px", color: "#6b7280", lineHeight: 1.5 }}>
                    I understand that when I claim food, my first name and contact information will be shared with the business providing the food so they can coordinate pickup. After pickup is confirmed, my full contact details will no longer be visible to the business. GAWA Loop will never sell my personal data.
                  </p>
                </div>
              </label>

              <label style={checkRow} onClick={() => setAccepted(a => ({ ...a, conduct: !a.conduct }))}>
                <div style={{ width: "20px", height: "20px", borderRadius: "5px", border: `2px solid ${accepted.conduct ? "#16a34a" : "#d1d5db"}`, background: accepted.conduct ? "#16a34a" : "#fff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "1px" }}>
                  {accepted.conduct && <span style={{ color: "#fff", fontSize: "13px", fontWeight: 700 }}>✓</span>}
                </div>
                <div>
                  <p style={{ margin: "0 0 2px", fontSize: "13px", fontWeight: 700, color: "#0a2e1a" }}>I agree to community conduct *</p>
                  <p style={{ margin: 0, fontSize: "12px", color: "#6b7280", lineHeight: 1.5 }}>
                    I will only claim food I genuinely intend to pick up. If I cannot pick up a reservation, I will cancel it so the food can go to someone else. I understand that repeated no-shows without cancellation may result in account suspension.
                  </p>
                </div>
              </label>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
                <div>
                  ...
                  <input style={inp} required value={form.firstName} onChange={e => setForm(f => ({ ...f, firstName: e.target.value }))}/>
                </div>
                <div>
