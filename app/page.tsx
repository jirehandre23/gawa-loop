      ...
      <nav className="sticky top-0 z-50 border-b border-slate-100 bg-white/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <Image src="/logo.png" alt="GAWA Loop" width={36} height={36} className="h-9 w-9 object-contain" />
          ...
          <div className="grid items-center gap-16 md:grid-cols-2">
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute -inset-6 rounded-full bg-gradient-to-br from-green-100 to-blue-100 blur-3xl opacity-70"></div>
                <div className="relative flex items-center justify-center rounded-3xl bg-white p-10 shadow-2xl ring-1 ring-slate-100">
                  <Image
                    src="/logo.png"
                    alt="GAWA Loop — Free food from local businesses"
                    width={300}
                    height={300}
                    className="h-auto w-64 object-contain drop-shadow-md"
                    priority
                  />
                </div>
              </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-100 bg-white p-8 shadow-sm hover:shadow-lg hover:border-green-200 transition-all">
            ...
            <p className="text-slate-500 leading-relaxed">See available food from restaurants and stores near you, updated in real time. Tap an address to get directions.</p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-100 bg-white p-8 shadow-sm hover:shadow-lg hover:border-orange-200 transition-all">
            ...
            <p className="text-slate-500 leading-relaxed">Head to the business, show your code, and enjoy your food. Plans changed? Cancel instantly from your email.</p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="mb-8 space-y-4">
                <div className="flex items-start gap-3">
                  <div className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-green-500 text-xs font-bold text-white">V</div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-green-100">
              <Image src="/logo.png" alt="" width={28} height={28} className="h-7 w-7 object-contain opacity-80" />
            </div>
            <h3 className="mb-2 text-lg font-bold text-slate-900">Safe reservations</h3>
            <p className="text-slate-500 text-sm leading-relaxed">Each claim gets a unique confirmation code. Only one person can claim each listing — no double bookings, ever.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">Instant email with your code, business details, map directions, and a one-click cancel option if plans change.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">Tap the address to open Google Maps, Apple Maps, or Waze. Get there fast with turn-by-turn directions.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">Listings refresh automatically. When food is claimed or expires, everyone sees the update instantly.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">No fees, no subscriptions, no hidden costs. GAWA Loop is free for customers and businesses. Always.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-8">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">Every claim prevents good food from being thrown away. Together we make a real environmental impact.</p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          <div className="mb-6 flex justify-center">
            <div className="rounded-2xl bg-white/20 p-4">
              <Image src="/logo.png" alt="GAWA Loop" width={64} height={64} className="h-16 w-16 object-contain brightness-0 invert" />
            </div>
          </div>
      ...
      <footer className="border-t border-slate-100 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-10">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="flex items-center gap-3">
              <Image src="/logo.png" alt="GAWA Loop" width={32} height={32} className="h-8 w-8 object-contain" />
