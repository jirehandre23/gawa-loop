...
export async function GET(req: NextRequest) {
  ...
  // Release or expire listing based on business timeline
  if (listing) {
    if (stillActive) {
      await supabase
        .from("listings")
      ...
      <body style="margin:0;padding:0;background:#f9fafb;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
        <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <div style="padding:36px 32px;">
            <h2 style="margin:0 0 8px;font-size:22px;font-weight:800;color:#111;">Reservation Cancelled</h2>
    ...
    await sendEmail(
      ...
      <body style="margin:0;padding:0;background:#f9fafb;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
        <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <div style="padding:36px 32px;">
            <h2 style="margin:0 0 8px;font-size:22px;font-weight:800;color:#111;">⚠️ Reservation Cancelled</h2>
            <p style="margin:0 0 20px;font-size:15px;color:#374151;">A customer cancelled their reservation for your listing.</p>
            <div style="background:#fff3cd;border:1px solid #ffc107;border-radius:12px;padding:20px 24px;margin-bottom:20px;">
              ...
              <p style="margin:2px 0;font-size:14px;color:#374151;"><b>Code:</b> ${claim.confirmation_code || "N/A"}</p>
            </div>
            <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:16px 24px;margin-bottom:24px;">
              <p style="margin:0;font-size:14px;color:#166534;font-weight:600;">
                ${stillActive ? "✅ Your listing is now AVAILABLE again for others to claim." : "⏰ The listing window has passed — marked as expired."}
              </p>
            </div>
            <div style="text-align:center;">
              <a href="https://gawaloop.com/business/dashboard" style="display:inline-block;background:#16a34a;color:#fff;font-weight:700;font-size:15px;padding:14px 32px;border-radius:12px;text-decoration:none;">View Dashboard</a>
            </div>
          </div>
          <div style="background:#f9fafb;padding:16px 32px;text-align:center;border-top:1px solid #e5e7eb;">
            <p style="margin:0;font-size:12px;color:#9ca3af;">gawaloop.com · Free food. Less waste. Real impact.</p>
  ...
  await sendEmail(
    ...
    `<html><body style="font-family:sans-serif;padding:24px;color:#111;">
      ...
      <table style="border-collapse:collapse;width:100%;font-size:14px;">
        ...
        <tr><td style="padding:8px 12px;background:#f9fafb;font-weight:600;">Listing</td><td style="padding:8px 12px;">${stillActive ? "✅ Back to AVAILABLE" : "⏰ Marked EXPIRED"}</td></tr>
      </table>
    </body></html>`
  );
