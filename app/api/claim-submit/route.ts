...
export async function POST(req: NextRequest) {
  ...
  // ATOMIC CLAIM — single database transaction, race-condition safe.
  // Uses FOR UPDATE SKIP LOCKED so two simultaneous requests can never both succeed.
  ...
  if (listing) {
    ...
    // 🔥 FIRE EMAILS IN BACKGROUND — non-blocking, same as before
    Promise.all([
